...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Versi digital Balikin gratis selamanya dengan maksimal 2 tag. Jika ingin produk fisik (gantungan kunci akrilik premium) dan unlimited tags, Anda bisa upgrade ke Premium seharga Rp 35.000 per tag.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Untuk pengguna gratis, maksimal 2 tag. Untuk unlimited tags dan produk fisik premium, Anda bisa upgrade ke Premium dengan harga Rp 35.000 per tag.',
  },
];
      ...
      <header className="border-b bg-white/90 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-4">
            ...
            <Link href="/dashboard">
              <Button className="shadow-lg shadow-blue-600/20">Dashboard</Button>
            </Link>
          </div>
        </div>
      </header>
          ...
          <Card className="max-w-2xl mx-auto bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 hover-card-effect">
            <CardContent className="pt-8 pb-8 text-center">
              ...
              <Button
                ...
                onClick={() => window.open('https://wa.me/6281234567890?text=Halo%2C%20saya%20tertarik%20untuk%20pesan%20QR%20Tag%20fisik%20Balikin', '_blank')}
              >
