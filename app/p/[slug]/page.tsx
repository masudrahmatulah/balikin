...
export default async function ProfilePage({ params }: ProfilePageProps) {
  ...
  // Use TabSwitcherHandler if Tab 2 is enabled, otherwise render directly
  if (tag.hasTabTwoEnabled) {
    return (
      <TabSwitcherHandler
        tag={tag}
        ...
        isAcrylicTag={isAcrylicTag}
        productLabel={productLabel}
        privateTabContent={<StudentKitModuleContent tag={tag} />}
      >
        {pageContent}
      </TabSwitcherHandler>
    );
  ...
  // Original rendering for tags without Tab 2
  return (
