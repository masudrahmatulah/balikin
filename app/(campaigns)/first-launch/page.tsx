...
const acrilicShapes = [
  { name: "Oval", image: "/showcase/oval ok 1.webp" },
  { name: "Persegi Panjang", image: "/showcase/persegi panjang ok 1.webp" },
  {
    name: "Persegi Panjang Timbul",
    image: "/showcase/persegi panjang timbul 1.webp",
  },
  {
    name: "Persegi Panjang Motif",
    image: "/showcase/persegi panjang motif 1.webp",
  },
  { name: "Hati", image: "/showcase/hati ok 1.webp" },
  { name: "Lingkaran", image: "/showcase/lingkaran ok 1.webp" },
  { name: "Persegi 8", image: "/showcase/persegi delapan 1.webp" },
];
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-950 shadow-2xl">
        ...
        <section className="relative overflow-hidden pt-10 pb-14 px-4">
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            <div className="max-w-xl mb-10 mx-auto">
              <h1 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white leading-tight">
                Barang Hilang
              ...
              <p className="text-base text-slate-600 dark:text-slate-300 mb-6 leading-relaxed font-light">
                Dapatkan akses lisensi <strong>Balikin Smart Tag</strong> —
                sistem pelacakan barang hilang paling canggih di Indonesia.
                Teknologi QR code + gantungan akrilik elegan memastikan barang
                berharga Anda selalu dapat ditemukan.
              </p>
              ...
              <div className="flex items-center gap-3 mb-6 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                <Trophy className="w-5 h-5 text-amber-600 dark:text-amber-400 flex-shrink-0" />
                <p className="text-xs text-amber-900 dark:text-amber-200">
                  <strong>Bonus Early Bird:</strong> 50% diskon untuk 100
                  pendaftar pertama!
                </p>
              </div>
            </div>
            ...
            {/* CTA Section */}
            <div className="bg-gradient-to-br from-blue-600 to-indigo-600 dark:from-blue-900/40 dark:to-indigo-900/40 rounded-2xl p-6 text-center border border-blue-300 dark:border-blue-800">
              <h2 className="text-2xl font-bold text-white dark:text-blue-50 mb-3">
                Jadilah Early Adopter Balikin
              </h2>
              <p className="text-blue-100 dark:text-blue-200 mb-6 text-base">
                Daftar sekarang dan dapatkan akses eksklusif ke lisensi Balikin
                Smart Tag. Kami akan menghubungi Anda dengan penawaran khusus
                segera!
              </p>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3 text-center">
              Lihat Balikin Smart Tag Beraksi
            </h2>
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-8 text-center">
              Kenali lebih dekat cara kerja Balikin dalam membantu barang hilang
              kembali ke pemiliknya
            </p>
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg border border-slate-200 dark:border-slate-800">
              <iframe
                className="w-full h-full"
                src="https://www.youtube-nocookie.com/embed/eJcko-jT_WE"
                title="Balikin Smart Tag - Video Produk"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {acrilicShapes.map((shape, idx) => (
                <div
                  key={idx}
                  className="group w-[calc(50%-0.5rem)] bg-white dark:bg-slate-800 rounded-xl p-8 text-center hover:shadow-lg dark:hover:shadow-blue-900/30 transition-all duration-300 transform hover:-translate-y-2"
                >
                  <div className="relative w-full aspect-square mb-4 overflow-hidden rounded-lg group-hover:scale-110 transition-transform duration-300">
                    <Image
                      src={shape.image}
                      alt={shape.name}
                      fill
            ...
            <div className="mt-12 p-6 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
              <p className="text-slate-700 dark:text-slate-300 text-center">
                Setiap desain akrilik dapat dikustomisasi dengan nama, foto,
                atau logo perusahaan Anda.
                <br className="hidden" />
                <strong>
                  Tambahan biaya desain custom tersedia dengan harga spesial
            ...
            <div className="grid gap-8">
              <div className="relative">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-center text-sm leading-relaxed">
                  Pasang gantungan akrilik Balikin pada barang berharga Anda
                  (kunci, tas, dll)
                </p>
                {/* Connector line */}
                <div className="hidden absolute top-8 -right-4 w-8 h-1 bg-gradient-to-r from-blue-600 to-transparent"></div>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-center text-sm leading-relaxed">
                  Jika barang hilang, penemu cukup scan QR code dengan
                  smartphone mereka
                </p>
                <div className="hidden absolute top-8 -right-4 w-8 h-1 bg-gradient-to-r from-indigo-600 to-transparent"></div>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-slate-600 dark:text-slate-400 text-center text-sm leading-relaxed">
                  Penemu bisa langsung menghubungi Anda via WhatsApp (nomor Anda
                  aman, tersembunyi)
                </p>
                <div className="hidden absolute top-8 -right-4 w-8 h-1 bg-gradient-to-r from-purple-600 to-transparent"></div>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-center text-sm leading-relaxed">
                  Barang hilang Anda kembali dengan aman, tanpa pembocoran data
                  pribadi
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-8">
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8 hover:shadow-lg dark:hover:shadow-blue-900/30 transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Nomor WhatsApp Anda tidak akan pernah terlihat oleh penemu.
                  Sistem relay kami menjaga privasi sepenuhnya dengan teknologi
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8 hover:shadow-lg dark:hover:shadow-indigo-900/30 transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Tidak perlu registrasi, login, atau dokumentasi rumit. Scan QR
                  code, kirim pesan — selesai. Dirancang untuk kesederhanaan
                  maksimal.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8 hover:shadow-lg dark:hover:shadow-purple-900/30 transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Teknologi QR code yang tidak bisa di-clone atau ditipu.
                  Database terenkripsi dengan standar keamanan banking-grade di
                  Supabase.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8 hover:shadow-lg dark:hover:shadow-orange-900/30 transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Gantungan akrilik berkualitas premium dengan 8 pilihan desain.
                  Tidak hanya fungsional, tapi juga mempercantik barang Anda.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-xl p-8 hover:shadow-lg dark:hover:shadow-cyan-900/30 transition-shadow">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  Bergabung dengan ribuan pengguna di seluruh Indonesia. Semakin
                  banyak pengguna = semakin besar kemungkinan barang ditemukan.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-8">
              <div className="flex gap-4 p-6 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Pasang pada tas, botol minum, atau gadget anak. Orang tua
                    akan tenang tahu barang penting anak aman jika hilang.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Amankan laptop bag, kamera, atau gadget profesional Anda.
                    Balikin memberikan peace of mind saat traveling.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Proteksi barang koleksi berharga Anda. Dari sepeda, motor,
                    hingga barang antik — semua bisa dilindungi.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 p-6 rounded-lg border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Branding giveaway terbaik untuk klien. Kombinasikan dengan
                    logo perusahaan di akrilik untuk sentuhan profesional.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <details className="group bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 cursor-pointer">
                <summary className="flex items-center justify-between font-bold text-slate-900 dark:text-white select-none">
                  <span>
                    Apakah Lisensi Balikin itu produk fisik atau digital?
                  </span>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-4 leading-relaxed">
                  Lisensi Balikin adalah akses ke ekosistem digital lengkap +
                  gantungan akrilik fisik berkualitas premium. Anda mendapatkan
                  akses ke platform Smart Tag kami + pengiriman akrilik pilihan
                  ke alamat Anda.
                </p>
              </details>
              ...
              <details className="group bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 cursor-pointer">
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-4 leading-relaxed">
                  Harga spesial akan kami berikan kepada 100 early supporters
                  pertama dengan diskon hingga 50%. Biaya reguler akan kami
                  jelaskan langsung setelah Anda mendaftar.
                </p>
              </details>
              ...
              <details className="group bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 cursor-pointer">
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-4 leading-relaxed">
                  Pengiriman standar 3-7 hari kerja tergantung lokasi. Untuk
                  early supporters kami juga menyediakan express shipping dengan
                  upgrade yang sangat terjangkau.
                </p>
              </details>
              ...
              <details className="group bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 p-6 cursor-pointer">
                <summary className="flex items-center justify-between font-bold text-slate-900 dark:text-white select-none">
                  <span>
                    Bisa custom desain akrilik dengan logo atau nama saya?
                  </span>
                  <span className="text-2xl group-open:rotate-45 transition-transform">
                    +
                  </span>
                ...
                <p className="text-slate-600 dark:text-slate-400 mt-4 leading-relaxed">
                  Tentu! Custom design tersedia dengan biaya tambahan yang
                  spesial untuk early supporters. Hubungi tim kami setelah Anda
                  mendaftar untuk konsultasi desain gratis.
                </p>
              </details>
            </div>
          </div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              Hanya 100 slot pertama yang mendapatkan diskon 50% + bonus
              eksklusif. Daftar sekarang dan amankan posisi Anda!
            </p>
            <div className="max-w-md mx-auto">
              <CampaignForm
                campaignName="first-launch"
        ...
        <footer className="border-t border-slate-200 dark:border-slate-800 py-12 px-4 bg-slate-50 dark:bg-slate-900">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-8 flex flex-col justify-between items-center gap-4 text-sm text-slate-600 dark:text-slate-400">
