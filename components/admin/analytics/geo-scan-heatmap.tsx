          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="flex flex-col items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                <MapPin className="w-5 h-5 text-blue-600 dark:text-blue-400 mb-1" />
              ...
              <div className="flex flex-col items-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                <MapPin className="w-5 h-5 text-purple-600 dark:text-purple-400 mb-1" />
                <p className="text-lg font-bold text-gray-900 dark:text-white truncate w-full text-center px-1">
                  {topCity?.city || "N/A"}
                </p>
