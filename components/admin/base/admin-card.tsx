...
export function AdminCard({
  ...
  const variantStyles = {
    ...
    bordered: "border-2 border-primary/20 shadow-md hover:shadow-lg transition-shadow",
    highlighted:
      "border-2 border-tertiary/40 bg-tertiary/[0.03] shadow-md hover:shadow-lg transition-shadow",
  };
