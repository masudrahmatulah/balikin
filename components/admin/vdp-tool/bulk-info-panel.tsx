    ...
    <Card className="bg-primary text-primary-foreground border-none shadow-xl overflow-hidden relative">
      <CardContent className="space-y-5 p-5 relative z-10">
        ...
        <div className="flex justify-between items-start">
          <div>
            <p className="font-label text-[9px] uppercase tracking-widest text-primary-foreground/60">Total Tags</p>
            <p className="font-display text-4xl font-bold mt-1">{quantity}</p>
          </div>
          <div className="text-right">
            <p className="font-label text-[9px] uppercase tracking-widest text-primary-foreground/60">Est. Sheets</p>
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-label text-[9px] uppercase tracking-widest text-primary-foreground/50">Material</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-label text-[9px] uppercase tracking-widest text-primary-foreground/50">Product</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-label text-[9px] uppercase tracking-widest text-primary-foreground/50">Paper Size</p>
        ...
        <div className="flex items-start gap-2 p-3 bg-surface/10 rounded-sm">
          ...
          <p className="font-body text-[10px] text-primary-foreground/80 leading-relaxed">
