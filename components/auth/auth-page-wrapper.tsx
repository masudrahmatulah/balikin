...
export function AuthPageWrapper({ children, title, description, icon, promo }: AuthPageWrapperProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-red-950/30">
      <SiteHeader />
      <div className="p-4 sm:flex sm:items-center sm:justify-center">
          ...
          <div className={promo ? "grid gap-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-center" : ""}>
            ...
            <div className="order-1 rounded-2xl border border-red-100 bg-white p-6 shadow-xl shadow-red-900/10 dark:border-red-900/50 dark:bg-slate-900 sm:p-8 lg:order-2">
              ...
              <div className="mt-6 text-center">
                <a
                  href="/"
                  className="rounded text-sm text-slate-600 transition-colors hover:text-brand-red focus:outline-none focus:ring-2 focus:ring-brand-red focus:ring-offset-2 dark:text-slate-400 dark:hover:text-red-300"
                >
