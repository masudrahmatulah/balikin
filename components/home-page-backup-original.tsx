/*
 * =====================================================================
 * BACKUP ORIGINAL HOMEPAGE STYLE
 * =====================================================================
 * Date Created: 2026-04-26
 * Purpose: Backup dari theme/style halaman utama yang asli
 *
 * CARA RESTORE:
 * 1. Copy seluruh isi file ini ke components/home-page.tsx
 * 2. Atau jalankan: cp home-page-backup-original.tsx home-page.tsx
 *
 * FITUR-FITUR YANG ADA:
 * - Hero section dengan animasi floating elements
 * - Pain points section (3 cards)
 * - Social proof dengan trust badges & testimonials
 * - Cara kerja section (3 steps dengan timeline)
 * - Scenarios section
 * - Product showcase
 * - Comparison section (Balikin vs Traditional)
 * - Before/After story section
 * - Benefits section dengan gradient background
 * - Bundle deals
