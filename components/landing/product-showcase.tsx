...
export function ProductShowcase({ className = '' }: ProductShowcaseProps) {
  ...
  const productGroups: ProductGroup[] = [
    ...
    {
      id: 'printable',
      label: 'Printable QR Tag',
      emoji: '🖨️',
      description: 'cetak sendiri tanpa watermark',
      products: [
        {
          name: 'Printable Single',
          price: 'Rp 35.000',
          icon: QrCode,
          features: ['1 lisensi QR aktif selamanya', 'PNG + PDF siap cetak', 'Tanpa watermark', 'Upload logo sendiri'],
          badge: 'Pro',
          badgeColor: 'bg-red-600',
          highlight: 'Mulai dari satu barang berharga',
          category: 'digital',
        },
        {
          name: 'Printable 5 / 10 Tag',
          price: 'Mulai Rp 125.000',
          icon: QrCode,
          features: ['Paket lisensi lebih hemat', 'PNG + PDF siap cetak', 'Tanpa watermark', 'Cocok untuk keluarga dan bisnis'],
          badge: 'Hemat',
          badgeColor: 'bg-emerald-600',
          highlight: 'Lindungi lebih banyak barang',
          category: 'digital',
        },
      ],
    },
